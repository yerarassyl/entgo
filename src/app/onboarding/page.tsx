          ...
          <div className="flex min-w-0 flex-col p-5 sm:p-8 lg:p-10 xl:p-12">
            ...
            {isSubjects && (
              <div className="mt-10">
                ...
                {selectedSubjects.length === 2 && !pairError && (
                  <div className="mt-4 flex items-start gap-3 rounded-2xl border border-[#bfdbfe] bg-[#eff6ff] p-4 text-sm text-[#1e40af]">
                    <Sparkles className="mt-0.5 size-5 shrink-0 text-[#2563eb]" />
                    <div>
                      <span className="font-bold text-[#1d4ed8]">Карьерные направления по этой связке:</span>
                      <p className="mt-1 text-xs font-semibold leading-5 text-[#2563eb] sm:text-sm">
                        {(() => {
                          const pair = [...selectedSubjects].sort().join(" + ");
                          const hints: Record<string, string> = {
                            "Математика + Физика": "IT, Инженерия, Архитектура, Строительство, Авиастроение, Энергетика",
                            "Информатика + Математика": "Программная инженерия, Искусственный интеллект, Кибербезопасность, Data Science",
                            "Биология + Химия": "Общая медицина, Стоматология, Педиатрия, Фармация, Биотехнологии",
                            "География + Математика": "Экономика, Финансы, Аудит, Маркетинг, Логистика, Менеджмент",
                            "Всемирная история + География": "Международные отношения, Регионоведение, Международный туризм",
                            "Всемирная история + Человек. Общество. Право": "Юриспруденция, Международное право, Таможенное дело, Правоохранение",
                            "Биология + География": "Экология, Агрономия, Геодезия, Ветеринария, Природные ресурсы",
                            "Иностранный язык + Математика": "Международный бизнес, Аналитика, ВЭД",
                            "География + Иностранный язык": "Международный туризм, Гостиничный бизнес, Переводческое дело",
                            "Всемирная история + Иностранный язык": "Международные отношения, Дипломатия, Востоковедение",
                            "Казахская литература + Казахский язык": "Филология, Журналистика, Издательское дело, Педагогика",
                            "Русская литература + Русский язык": "Филология, Журналистика, Медиакоммуникации, Педагогика",
                            "Физика + Химия": "Химическая технология, Нефтегазовое дело, Нанотехнологии, Материаловедение",
                            "Математика + Химия": "Фармацевтическая инженерия, Технологии пищевых производств",
                          };
                          return hints[pair] || "Индивидуальные образовательные программы и специальности бакалавриата";
                        })()}
                      </p>
                    </div>
                  </div>
