...
const faqs = [
  ...
  {
    question: "entgo.ai действительно анализирует мои ошибки?",
    answer: (
      <p>
        Да. entgo.ai не просто показывает правильный ответ. Он анализирует твои ошибки,
...
const advantages = [
  ...
  "entgo.ai анализирует именно твои ошибки",
];
