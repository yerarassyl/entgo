...
export default async function PremiumPage({ searchParams }: PageProps<"/premium">) {
  ...
  if (query.payment === "return" && subscription) redirect("/dashboard");
  ...
  return (
    <main className="mobile-app-page product-v2 min-h-screen bg-paper pb-24 text-[#172033]">
      ...
      <section className="container-shell max-w-5xl py-12 text-center sm:py-16">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#737d8e]">Получи полный доступ к персональному плану, entgo.ai-помощнику и всем инструментам подготовки.</p>
